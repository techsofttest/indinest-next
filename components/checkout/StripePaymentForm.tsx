        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="bg-white rounded-3xl border border-gray-100 p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-6">
                    <div className="w-10 h-10 rounded-2xl bg-blue-50 flex items-center justify-center text-[#010526]">
                        <Lock className="w-5 h-5" />
                    </div>
                    <div>
                        <h2 className="text-lg font-bold text-gray-900 font-sans">Secure Payment</h2>
                        <p className="text-xs text-gray-500 font-medium font-sans">Order: #{orderNumber}</p>
                    </div>
                </div>
                ...
                <button
                    ...
                    className="w-full mt-6 bg-[#010526] hover:opacity-90 disabled:bg-gray-200 text-white font-bold text-sm py-4 px-6 rounded-2xl shadow-md transition-all duration-300 flex items-center justify-center gap-2 cursor-pointer uppercase tracking-widest font-sans"
                >
                    {isProcessing ? (
                        <>
